...
/*   Updated: 2025/09/17 19:49:37 by ibour            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	event_action_move(const int k, t_data *data)
{
	...
	else if (k == KEY_NUMPAD_8)
		data->map.alpha += ANGLE_INCR;
	else if (k == KEY_NUMPAD_6)
		data->map.beta += ANGLE_INCR;
	else if (k == KEY_NUMPAD_2)
		data->map.alpha -= ANGLE_INCR;
	else if (k == KEY_NUMPAD_7 || k == KEY_NUMPAD_9)
		data->map.gamma += ANGLE_INCR;
	else if (k == KEY_NUMPAD_1 || k == KEY_NUMPAD_3)
		data->map.gamma -= ANGLE_INCR;
	if (k == KEY_A)
