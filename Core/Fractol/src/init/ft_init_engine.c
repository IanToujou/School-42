...
/*   Updated: 2024/12/09 09:25:13 by ibour            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/fractol.h"

static void	ft_check_error(const t_engine *engine)
{
...
void	ft_init_engine(t_engine *engine, char *fractal)
{
	...
	engine->window = mlx_new_window(engine->mlx, WINDOW_SIZE,
			WINDOW_SIZE, "Fractol");
	engine->image.mlx_image = mlx_new_image(engine->mlx, WINDOW_SIZE,
			WINDOW_SIZE);
	ft_check_error(engine);
