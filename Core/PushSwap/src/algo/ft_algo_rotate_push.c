...
/*   Updated: 2024/11/05 13:43:43 by ibour            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/push_swap.h"

int	ft_algo_push_rarb(t_stack **stack_a, t_stack **stack_b, const int c, const char s)
{
	if (s == 'a')
	{
...
int	ft_algo_push_rrarrb(t_stack **stack_a, t_stack **stack_b, const int c, const char s)
{
	if (s == 'a')
	{
		while ((*stack_a)->num != c && ft_stack_place_b(*stack_b, c) > 0)
...
int	ft_algo_push_rrarb(t_stack **stack_a, t_stack **stack_b, const int c, const char s)
{
	if (s == 'a')
	{
		while ((*stack_a)->num != c)
...
int	ft_algo_push_rarrb(t_stack **stack_a, t_stack **stack_b, const int c, const char s)
{
	if (s == 'a')
	{
		while ((*stack_a)->num != c)
